...
Dynamic reporting using `dyndoc` or `markstat` is a great way to work with Stata. However, not everyone wants to take on the whole workflow of producing documents programmatically, it is useful to have a script that analyses your data and exports tables of results as you go.
...
So this will create an Excel or tex file with the results of table. You can use .docx, .html, and .pdf files (see the Stata documentation for the full list) as well as .xls(x) and .tex.
