...
Dynamic reporting using `dyndoc` or `markstat` is a great way to work with Stata. However, not everyone wants to and there are times when it is useful to have a script that analyses your data and exports tables of results as you go.

One of the simples ways to do this is to use `collect export` in your scripts after you run a routine. Suppose that you create a simple cross tabulation, for example
